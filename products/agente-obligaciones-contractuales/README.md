...
`agente-obligaciones-contractuales` lee contratos, anexos, correos y plantillas internas; extrae obligaciones y fechas; marca riesgos; recupera evidencia trazable; y genera salidas utiles para una primera revision documental.
...
Desde la carpeta `agente-obligaciones-contractuales`:
