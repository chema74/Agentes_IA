...
class Settings:
    app_name: str = _env("APP_NAME", "geopolitical-trade-intelligence-agent")
    app_env: str = _env("APP_ENV", "demo")
    app_base_url: str = _env("APP_BASE_URL", "http://127.0.0.1:8070")
    service_api_key: str = _env("SERVICE_API_KEY", "trade-dev-key")
    ...
    neon_database_url: str = _env("NEON_DATABASE_URL", "sqlite:///./data/geopolitical_trade_intelligence.sqlite3")
    langsmith_api_key: str = _env("LANGSMITH_API_KEY")
    langsmith_project: str = _env("LANGSMITH_PROJECT", "geopolitical-trade-intelligence")
